...
const mkdirpSync = __webpack_require__(63).mkdirsSync
...
const typed_chrome_webstore_api_1 = __webpack_require__(301);
const writeStreamToFile_1 = __webpack_require__(872);
function run() {
...
function runImpl() {
    return __awaiter(this, void 0, void 0, function* () {
        const readStream = yield typed_chrome_webstore_api_1.DownloadCrx.downloadCrx(actionInputs_1.actionInputs.extensionId, actionInputs_1.actionInputs.prodVersion, actionInputs_1.actionInputs.acceptFormat, getPlatformOptions());
        yield writeStreamToFile_1.writeStreamToFile(actionInputs_1.actionInputs.crxFilePath, readStream);
        actionOutputs_1.actionOutputs.crxFilePath.setValue(actionInputs_1.actionInputs.crxFilePath);
    });
}
function getPlatformOptions() {
    if (actionInputs_1.actionInputs.platformArch && actionInputs_1.actionInputs.platformOs && actionInputs_1.actionInputs.platformNaclArch) {
        return {
            arch: actionInputs_1.actionInputs.platformArch,
            os: actionInputs_1.actionInputs.platformOs,
            naclArch: actionInputs_1.actionInputs.platformNaclArch
        };
    }
    else if (!haveTheSameStatus(actionInputs_1.actionInputs.platformArch, actionInputs_1.actionInputs.platformOs, actionInputs_1.actionInputs.platformNaclArch)) {
...
const fs = __webpack_require__(598)
const path = __webpack_require__(622)
const mkdirp = __webpack_require__(63).mkdirs
const pathExists = __webpack_require__(322).pathExists
...
exports.actionInputs = {
    ...
    prodVersion: github_actions_utils_1.actionInputs.getString('prodVersion', true),
    acceptFormat: github_actions_utils_1.transformIfSet(github_actions_utils_1.actionInputs.getString('acceptFormat', true), s => s.split('|')),
    platformOs: github_actions_utils_1.actionInputs.getString('platformOs', false),
    platformArch: github_actions_utils_1.actionInputs.getString('platformArch', false),
    platformNaclArch: github_actions_utils_1.actionInputs.getString('platformNaclArch', false),
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.writeStreamToFile = void 0;
const path_1 = __importDefault(__webpack_require__(622));
const fs = __importStar(__webpack_require__(232));
function writeFinished(stream) {
    return new Promise((resolve, reject) => {
        stream.on('finish', resolve);
        stream.on('error', reject);
    });
}
function writeToFile(filePath, src) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (Buffer.isBuffer(src)) {
                yield fs.writeFile(filePath, src);
            }
            else {
                ...
                yield writeFinished(writeStream);
            }
        }
        catch (error) {
            try {
...
function writeStreamToFile(filePath, src) {
    return __awaiter(this, void 0, void 0, function* () {
        yield fs.ensureDir(path_1.default.dirname(filePath));
