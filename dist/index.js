...
exports.actionInputs = {
    ...
    acceptFormat: (0, github_actions_utils_1.transformIfSet)(github_actions_utils_1.actionInputs.getString('acceptFormat', true), s => s.split('|')),
...
const writeStreamToFile_1 = __nccwpck_require__(7639);
function run() {
...
function runImpl() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, writeStreamToFile_1.writeStreamToFile)(actionInputs_1.actionInputs.crxFilePath, readStream);
